...
const Profile = ({ navigation, onTabChange }: any) => {
  ...
  const handleSignOut = () => {
    ...
    if (navigation) {
      // Get parent navigator to access root stack
      const parent = navigation.getParent();
      if (parent) {
        parent.replace('LandingPage');
      } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        {/* Name */}
        <Text style={styles.name}>George Kaunang</Text>

        <Gap height={8} />

        {/* Email */}
        <Text style={styles.email}>kunangkunang@gmail.com</Text>
